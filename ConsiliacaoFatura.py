...
diretorio = os.getcwd()
CaminhoTARIFARIO = os.path.join(
    diretorio, "input2", "Conciliacao_Nuclea", "TARIFARIO", "tabelaprecos_nuclea.xlsx"
)
...
df_tarifario = pd.read_excel(CaminhoTARIFARIO)
...
df_fatura = pd.concat(
    [df_agenda_nuclea, df_agenda_cerc, df_agenda_tag, df_agenda_b3, df_eventos42]
)
...
# print(df_agenda_nuclea)
# print(df_agenda_cerc)
# print(df_agenda_tag)
# print(df_agenda_b3)
...
with pd.ExcelWriter(saidaFatura) as writer:
    ...
    # df_final39.to_excel(writer,sheet_name='CRRC039')
